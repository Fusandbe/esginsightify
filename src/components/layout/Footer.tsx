...
const Footer = () => {
  ...
  return (
    <footer className="bg-muted/50 py-16 border-t relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 bg-accent/5 rounded-full -translate-y-1/3 translate-x-1/4 blur-3xl pointer-events-none"></div>
      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4 md:gap-8">
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold tracking-wider uppercase">Product</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  to="/features"
                  className="text-muted-foreground transition-colors hover:text-foreground flex items-center gap-1 group"
                >
                  Features
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold tracking-wider uppercase">Contact</h3>
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@esginsightify.com" className="text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="mt-16 flex flex-col md:flex-row justify-between items-center border-t border-muted-foreground/20 pt-8">
